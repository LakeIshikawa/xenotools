...
Entity[ "1" ] = {
    ...
    script_0x05 = function( self )
        -- 0x26_Wait( time=10 ) -- 0x0d9b 0x26
        -- MISSING OPCODE 0x4a
    end,

    script_0x06 = function( self )
        -- 0x26_Wait( time=5 ) -- 0x0da5 0x26
        -- MISSING OPCODE 0x4a
    end,
    ...
    script_0x12 = function( self )
        -- 0x26_Wait( time=10 ) -- 0x0e4d 0x26
        -- 0xF5_DialogShow3( dialog_id=0x0013, flaf=0x21 ) -- 0x0e50 0xf5
        -- 0x9C() -- 0x0e54 0x9c
    ...
    script_0x16 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0015, flaf=0x21 ) -- 0x0eea 0xf5
        -- 0x9C() -- 0x0eee 0x9c
        -- MISSING OPCODE 0x36
    end,
...
Entity[ "2" ] = {
    ...
    script_0x04 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0016, flaf=0x21 ) -- 0x0f0f 0xf5
        -- 0x9C() -- 0x0f13 0x9c
        -- 0xD0() -- 0x0f14 0xd0
...
Entity[ "6" ] = {
    ...
    script_0x06 = function( self )
        ...
        -- 0x5A() -- 0x16aa 0x5a
        -- 0xF1() -- 0x16ab 0xf1
        -- 0x26_Wait( time=2 ) -- 0x16b6 0x26
        -- 0xF1() -- 0x16b9 0xf1
        -- 0x5A() -- 0x16c4 0x5a
        -- 0xF1() -- 0x16c5 0xf1
        -- 0x26_Wait( time=5 ) -- 0x16d0 0x26
...
Entity[ "9" ] = {
    ...
    script_0x04 = function( self )
        -- 0x26_Wait( time=30 ) -- 0x1825 0x26
        -- 0x08_EntityCallScriptSW( entity=0x06, script=0x24 ) -- 0x1828 0x08
        -- 0x35() -- 0x182b 0x35
        -- 0x63() -- 0x1831 0x63
        -- 0xA3() -- 0x1839 0xa3
        -- 0x05_CallFunction( 0x2b2b ) -- 0x1841 0x05
        -- 0x26_Wait( time=10 ) -- 0x1844 0x26
        -- MISSING OPCODE 0x36
    end,
    ...
    script_0x0b = function( self )
        -- 0x26_Wait( time=6 ) -- 0x18c3 0x26
        -- 0x08_EntityCallScriptSW( entity=0x06, script=0x25 ) -- 0x18c6 0x08
        return 0 -- 0x18c9 0x00
    end,

    script_0x0c = function( self )
        -- 0x26_Wait( time=5 ) -- 0x18ca 0x26
        -- MISSING OPCODE 0x69
    end,

    script_0x0d = function( self )
        -- 0x26_Wait( time=5 ) -- 0x18d1 0x26
        -- MISSING OPCODE 0x69
    end,
    ...
    script_0x12 = function( self )
        -- 0x26_Wait( time=25 ) -- 0x1959 0x26
        -- 0x35() -- 0x195c 0x35
        -- 0x63() -- 0x1962 0x63
        -- 0xA3() -- 0x196a 0xa3
        -- 0x05_CallFunction( 0x2b2b ) -- 0x1972 0x05
        -- 0x09_EntityCallScriptEW( entity=0x01, script=0x71 ) -- 0x1975 0x09
        -- 0x26_Wait( time=30 ) -- 0x1978 0x26
        -- 0x35() -- 0x197b 0x35
        -- 0x63() -- 0x1981 0x63
        -- 0xA3() -- 0x1989 0xa3
    ...
    script_0x13 = function( self )
        -- 0x26_Wait( time=40 ) -- 0x1995 0x26
        -- MISSING OPCODE 0xFE3c
    end,

    script_0x14 = function( self )
        -- 0x26_Wait( time=8 ) -- 0x19b8 0x26
        -- 0x08_EntityCallScriptSW( entity=0x02, script=0x7a ) -- 0x19bb 0x08
        -- 0x35() -- 0x19be 0x35
        -- 0x63() -- 0x19c4 0x63
        -- 0xA3() -- 0x19cc 0xa3
...
Entity[ "10" ] = {
    ...
    script_0x04 = function( self )
        -- 0x26_Wait( time=10 ) -- 0x1b2d 0x26
        -- MISSING OPCODE 0x69
    end,

    script_0x05 = function( self )
        -- 0x26_Wait( time=5 ) -- 0x1b34 0x26
        -- MISSING OPCODE 0x4a
    end,
    ...
    script_0x0f = function( self )
        -- 0xF1() -- 0x1bef 0xf1
        -- 0x26_Wait( time=1 ) -- 0x1bfa 0x26
        -- 0xF1() -- 0x1bfd 0xf1
        -- 0x5A() -- 0x1c08 0x5a
        -- 0xF1() -- 0x1c09 0xf1
        -- 0x5A() -- 0x1c14 0x5a
        -- 0xF1() -- 0x1c15 0xf1
        -- 0x26_Wait( time=10 ) -- 0x1c20 0x26
        -- MISSING OPCODE 0x28
    end,

    script_0x10 = function( self )
        -- 0x26_Wait( time=30 ) -- 0x1c26 0x26
        -- 0x35() -- 0x1c29 0x35
        -- 0x63() -- 0x1c2f 0x63
        -- 0xA3() -- 0x1c37 0xa3
        -- 0x05_CallFunction( 0x2b2b ) -- 0x1c3f 0x05
        -- 0x26_Wait( time=5 ) -- 0x1c42 0x26
        -- 0x09_EntityCallScriptEW( entity=0x06, script=0x25 ) -- 0x1c45 0x09
        -- 0x26_Wait( time=5 ) -- 0x1c48 0x26
        return 0 -- 0x1c4b 0x00
    end,

    script_0x11 = function( self )
        -- 0x26_Wait( time=20 ) -- 0x1c4c 0x26
        -- 0x35() -- 0x1c4f 0x35
        -- 0x63() -- 0x1c55 0x63
        -- 0xA3() -- 0x1c5d 0xa3
    ...
    script_0x18 = function( self )
        -- 0x26_Wait( time=60 ) -- 0x1ce4 0x26
        -- 0x08_EntityCallScriptSW( entity=0x06, script=0x26 ) -- 0x1ce7 0x08
        return 0 -- 0x1cea 0x00
    end,

    script_0x19 = function( self )
        -- 0x26_Wait( time=80 ) -- 0x1ceb 0x26
...
Entity[ "12" ] = {
    ...
    script_0x04 = function( self )
        ...
        -- 0xF1() -- 0x1dc0 0xf1
        -- 0x26_Wait( time=1 ) -- 0x1dcb 0x26
        -- 0x35() -- 0x1dce 0x35
        -- 0x63() -- 0x1dd4 0x63
        -- 0xA3() -- 0x1ddc 0xa3
        -- 0x05_CallFunction( 0x2b2b ) -- 0x1de4 0x05
        -- 0x26_Wait( time=1 ) -- 0x1de7 0x26
        -- 0xF1() -- 0x1dea 0xf1
        -- 0x26_Wait( time=1 ) -- 0x1df5 0x26
        -- 0x35() -- 0x1df8 0x35
        -- 0x63() -- 0x1dfe 0x63
        -- 0xA3() -- 0x1e06 0xa3
        -- 0x05_CallFunction( 0x2b2b ) -- 0x1e0e 0x05
        -- 0xF1() -- 0x1e11 0xf1
        -- 0x26_Wait( time=1 ) -- 0x1e1c 0x26
        -- 0x35() -- 0x1e1f 0x35
        -- 0x63() -- 0x1e25 0x63
        -- 0xA3() -- 0x1e2d 0xa3
        -- 0x05_CallFunction( 0x2b2b ) -- 0x1e35 0x05
        -- 0x26_Wait( time=1 ) -- 0x1e38 0x26
        -- 0xF1() -- 0x1e3b 0xf1
        -- 0x26_Wait( time=1 ) -- 0x1e46 0x26
        -- 0x35() -- 0x1e49 0x35
        -- 0x63() -- 0x1e4f 0x63
        -- 0xA3() -- 0x1e57 0xa3
        -- 0x05_CallFunction( 0x2b2b ) -- 0x1e5f 0x05
        -- 0xF1() -- 0x1e62 0xf1
        -- 0x26_Wait( time=1 ) -- 0x1e6d 0x26
        -- 0x35() -- 0x1e70 0x35
        -- 0x63() -- 0x1e76 0x63
        -- 0xA3() -- 0x1e7e 0xa3
        -- 0x05_CallFunction( 0x2b2b ) -- 0x1e86 0x05
        -- 0x26_Wait( time=1 ) -- 0x1e89 0x26
        -- 0xF1() -- 0x1e8c 0xf1
        -- 0x26_Wait( time=1 ) -- 0x1e97 0x26
        -- 0x35() -- 0x1e9a 0x35
        -- 0x63() -- 0x1ea0 0x63
        -- 0xA3() -- 0x1ea8 0xa3
        -- 0x05_CallFunction( 0x2b2b ) -- 0x1eb0 0x05
        -- 0xF1() -- 0x1eb3 0xf1
        -- 0x26_Wait( time=1 ) -- 0x1ebe 0x26
        -- 0x35() -- 0x1ec1 0x35
        -- 0x63() -- 0x1ec7 0x63
        -- 0xA3() -- 0x1ecf 0xa3
        -- 0x05_CallFunction( 0x2b2b ) -- 0x1ed7 0x05
        -- 0x26_Wait( time=1 ) -- 0x1eda 0x26
        -- 0xF1() -- 0x1edd 0xf1
        -- 0x26_Wait( time=1 ) -- 0x1ee8 0x26
        -- 0xF1() -- 0x1eeb 0xf1
        -- 0x26_Wait( time=1 ) -- 0x1ef6 0x26
...
Entity[ "31" ] = {
    ...
    script_0x05 = function( self )
        -- 0x26_Wait( time=30 ) -- 0x2ac4 0x26
        -- 0xFE0D_SetAvatar( character_id=0 ) -- 0x2ac7 0xfe
        -- 0xF5_DialogShow3( dialog_id=0x0034, flaf=0x29 ) -- 0x2acb 0xf5
        -- 0x9C() -- 0x2acf 0x9c
        -- MISSING OPCODE 0x36
    end,
