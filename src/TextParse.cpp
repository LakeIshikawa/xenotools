...
void
TextParse(Logger* expt, File* file, const int offset)
{
    ...
    while (true)
    {
        ...
        else if (opcode == 0x0f)
        {
            ...
            if (sub_opcode == 0x00)
            {
                expt->LogW("<SpecialWait wait=\"" + HexToString(file->GetU8(data_offset), 2, '0') + "\">");
                data_offset += 1;
            }
            else if (sub_opcode == 0x01)
            {
                expt->LogW("<SpecialLettersToRead number=\"" + HexToString(file->GetU8(data_offset), 2, '0') + "\">");
                data_offset += 1;
            }
            else if (sub_opcode == 0x02)
            {
                expt->LogW("<SpecialWaitAndClose wait=\"" + HexToString(file->GetU8(data_offset), 2, '0') + "\">");
                data_offset += 1;
            }
            else if (sub_opcode == 0x05)
            {
                expt->LogW("<SpecialCharacter char_id=\"" + HexToString(file->GetU8(data_offset), 2, '0') + "\">");
                data_offset += 1;
            }
            else
            {
                expt->LogW("<special>" + HexToString(sub_opcode, 2, '0') + "\n");
                break;
            }
        }
        else if (opcode < 0xf8)
        {
            ...
            {
                expt->LogW("[MISSING 0x" + HexToString(opcode, 2, '0') + "]");
            }
        }
        else if (opcode == 0xf8)
        {
            ...
            {
                expt->LogW("[MISSING 0xF8" + HexToString(sub_opcode, 2, '0') + "]");
            }
        }
        else if (opcode == 0xf9)
        {
            ...
            {
                expt->LogW("[MISSING 0xF9" + HexToString(sub_opcode, 2, '0') + "]");
            }
        }
        else if (opcode == 0xfa)
        {
            ...
            {
                expt->LogW("[MISSING 0xFA" + HexToString(sub_opcode, 2, '0') + "]");
            }
        }
        else if (opcode == 0xfb)
        {
            ...
            {
                expt->LogW("[MISSING 0xFB" + HexToString(sub_opcode, 2, '0') + "]");
            }
        }
        else if (opcode == 0xfc)
        {
            ...
            {
                expt->LogW("[MISSING 0xFC" + HexToString(sub_opcode, 2, '0') + "]");
            }
        }
        else if (opcode == 0xfd)
        {
            ...
            {
                expt->LogW("[MISSING 0xFD" + HexToString(sub_opcode, 2, '0') + "]");
            }
        }
        else
        {
